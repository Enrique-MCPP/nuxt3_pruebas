...
/* build-hook-start *//*00001*/try { require('C:\\Users\\emalc\\.vscode\\extensions\\wallabyjs.console-ninja-0.0.156\\out\\buildHook\\index.js').default({tool: 'nuxt'}); } catch(e) { try { import('file:///C:/Users/emalc/.vscode/extensions/wallabyjs.console-ninja-0.0.156/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt'})).catch(p => {}) } catch(e) { }}/* build-hook-end */
